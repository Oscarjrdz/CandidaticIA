...
const CRMProjectsSection = () => {
    ...
    return (
        <DndContext sensors={sensors} collisionDetection={closestCenter} onDragStart={handleDragStart} onDragOver={handleDragOver} onDragEnd={handleDragEnd} onDragCancel={handleDragCancel}>
                        ...
                        <>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <button 
                                        onClick={() => setCalendarModalConfig({ isOpen: true, projectId: activeProject.id, projectName: activeProject.name, candidateId: null, candidateName: '' })}
                                        className="p-1.5 rounded-lg bg-orange-100 hover:bg-orange-200 dark:bg-orange-900/30 dark:hover:bg-orange-900/50 text-orange-600 dark:text-orange-400 transition-colors"
            ...
            <CalendarNotesModal 
                isOpen={calendarModalConfig.isOpen}
                onClose={() => setCalendarModalConfig({ ...calendarModalConfig, isOpen: false })}
                projectId={calendarModalConfig.projectId}
