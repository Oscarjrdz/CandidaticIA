                ...
                <div className="p-3 bg-white dark:bg-[#111b21] border-b border-[#f0f2f5] dark:border-[#222e35]">
                    ...
                    {availableTags.length > 0 && (
                        <div className="flex flex-wrap gap-1.5 pb-2">
                            <div className="flex items-center gap-1 text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-wider mr-1 self-center">
                            ...
                            {availableTags.map((tag, idx) => {
                                ...
                                const isActive = selectedTagFilter === tName;
                                ...
                                return (
                                    <button
                                        key={idx}
                                        onClick={() => setSelectedTagFilter(isActive ? null : tName)}
                                        className={`px-2.5 py-1 rounded-full text-[11px] font-semibold whitespace-nowrap transition-all border flex items-center gap-1.5 ${
                                            isActive
                                                ? 'text-white shadow-sm scale-105'
                                                : 'bg-white dark:bg-[#202c33] text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-500'
                                        }`}
                                        style={isActive ? { backgroundColor: tColor, borderColor: tColor } : {}}
                                    >
                                        <span
                                            className="w-2 h-2 rounded-full shrink-0"
                                            style={{ backgroundColor: isActive ? '#fff' : tColor }}
                                        />
                                        {tName}
                                        <span className={`text-[9px] font-bold ${isActive ? 'text-white/80' : 'text-gray-400'}`}>({countWithTag})</span>
