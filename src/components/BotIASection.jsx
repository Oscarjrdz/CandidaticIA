                ...
                >
                    <div className="space-y-4">
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                className="w-full h-[160px] p-4 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-900/40 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 text-xs resize-none transition-all leading-relaxed font-medium"
                                value={systemPrompt}
