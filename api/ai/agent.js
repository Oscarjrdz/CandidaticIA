                ...
                if (isNewFlag) {
                    ...
                    if (auditForMode.missingLabels.length > 0) {
                        if (customPrompt) {
                            ...
                            if (isVacancyQ) {
                                systemInstruction += `\n[NOTA DE CONTEXTO]: El candidato preguntó sobre vacantes/entrevistas. Responde en DOS burbujas usando [MSG_SPLIT]: Burbuja 1 = MÁXIMO 2 líneas, personalidad cálida CON emoji, reconoce brevemente la pregunta y di que primero necesitas sus datos. Burbuja 2 = La pregunta del dato faltante CON emoji: ${auditForMode.missingLabels[0]}.\n`;
                            } else if (isPersonalQ) {
