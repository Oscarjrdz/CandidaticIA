...
export async function assembleSystemPrompt() {
    ...
    parts.push(
        ...
        '- `ver_cola_agent_candidatic`: si está prendido/apagado, para qué etiqueta(s), y la lista de candidatos en la cola de atención con su status. Úsala cuando pregunten "quién está en la cola" o "cómo va el agente en vivo".\n' +
